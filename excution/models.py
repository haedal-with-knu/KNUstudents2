...
class Post_introduction(models.Model):
    author = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='user_excution_introduction')
...
class Post_board(models.Model):
    author = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='user_excution_board')
